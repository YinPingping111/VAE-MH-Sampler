...
VAE_MH_samples = np.loadtxt("D:/desk/VAE-MH/VAE/examples/T_2D_55/samples.dat")
...
RMH_samples = np.loadtxt("D:/desk/VAE-MH/VAE/examples/T_2D_55/comparison_samples.dat")
...
GTC_VAE_MH.savefig(os.path.join(outdir, 'VAE_MH(T_2D_55).pdf'), bbox_inches='tight')
print(f"Figure saved to {outdir}/VAE_MH(T_2D_55).pdf")
GTC_RMH.savefig(os.path.join(outdir, 'RMH(T_2D_55).pdf'), bbox_inches='tight')
print(f"Figure saved to {outdir}/RMH(T_2D_55).pdf")