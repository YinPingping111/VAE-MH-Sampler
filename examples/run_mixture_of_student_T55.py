...
def target(x,dim):
    ...
    t_pdf_1 = multivariate_t_pdf(x, mean_1, cov_1, df)
    t_pdf_2 = multivariate_t_pdf(x, mean_2, cov_2, df)
...
# Pure MH samples = 99999 Pure MH Acceptance efficiency =  0.43749
# Time taken MH: 76.84855771064758
...
# VAE acceptance efficiency = 0.8092783505154639
# Metropolis acceptance efficiency = 0.3920595533498759
# Previous Retrain Time = 4.0 seconds
# Total Retrain Time = 492.0 seconds
# Time taken vae: 494.03564167022705